  ...
  const fmtEmailDT = iso => {
    ...
    // fetch loop (frontend-driven polling)
    useEffect(() => {
      ...
      {updateAvailable && (
        ...
        <div className="flex items-center justify-between bg-transparent border-b p-3 shadow-sm">
          <div className="flex items-center">
            <a href="https://www.outprio.com" className="transition-transform hover:scale-110" target="_blank" rel="noopener noreferrer">
              <img src={logo} alt="Logo" width="40%" className="ml-7 mt-2" />
            </a>
          </div>
          <div className="flex items-center space-x-7 text-gray-200 mr-7">
              ...
              {showStatusDropdown && (
                <div className="absolute top-6 left-0 p-2 w-44 bg-white text-black rounded shadow-lg">
                  <div className="flex items-center mb-2 text-sm text-gray-600">
                    <span className={`h-2 w-2 rounded-full mr-2 ${cloudOk ? "bg-green-500" : "bg-amber-400"}`} />
                    Outprio Cloud
                  </div>
                  <div className="flex items-center mb-2 text-sm text-gray-600">
                    <span className={`h-2 w-2 rounded-full mr-2 ${outlookOk ? "bg-green-500" : "bg-amber-400"}`} />
                    Outlook
                  </div>
                  <div className="flex items-center mb-2 text-sm text-gray-600">
                    <span className={`h-2 w-2 rounded-full mr-2 ${localOk ? "bg-green-500" : "bg-amber-400"}`} />
                    Local services
                  </div>
                </div>
              )}
            ...
            <button onClick={() => open('https://outprio.netlify.app/dashboard')} title="Account">
                <User className="h-5 w-5 mt-0" />
            </button>
            <button onClick={() => open('https://outprio.com/support')} title="Help">
                <HelpCircle className="h-5 w-5 mt-0" />
            </button>
            <button
              onClick={async () => {
...
<div className="text-1xl font-semibold text-[#F4D9FF] mt-1">
  Last {config.lookback_hours >= 24
    ? `${Math.round(config.lookback_hours / 24)} ${
        Math.round(config.lookback_hours / 24) === 1 ? 'day' : 'days'
      }`
    : `${config.lookback_hours} ${
        config.lookback_hours === 1 ? 'hour' : 'hours'
      }`}
</div>
                            ...
                            >
                                ...
                                {e.reason.split("+").map((r, i) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <span className="bg-[#B1699F] text-[#FFFFFF] text-xs font-medium px-2 py-1 rounded">
                                        {disp}
                                      </span>
                                    </div>
                                  );
                              ...
                              <td className="px-4 py-2 text-center">
                                <button
                                  ...
                                  className="hover:text-[#1E61B0]"
                                >
                                  <MailOpen strokeWidth={1.5} className="h-5 w-5 text-[#1E89D1] cursor-pointer" />
                                </button>
                              </td>
                              <td className="px-4 py-2 text-center">
                                <button
                                ...
                                className="hover:text-[#B04B79]"
                              >
                                <MailCheck strokeWidth={1.5} className="h-5 w-5 text-[#D274AA] cursor-pointer" />
                              </button>
                              </td>
                              <td className="px-4 py-2 text-center">
                                <button
                                ...
                                className="hover:text-[#B04B79]"
                              >
                                <CopyCheck strokeWidth={1.5} className="h-5 w-5 text-[#D274AA] cursor-pointer" />
                              </button>
                              </td>
                            </tr>
                          ))}
